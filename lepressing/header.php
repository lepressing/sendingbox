...
<!-- Start the main container / Add Effect with id page_effect & style=display:none-->
<section id="page_effect" class="container row greyy" role="document" style="display:none;">
<!-- Effect -->